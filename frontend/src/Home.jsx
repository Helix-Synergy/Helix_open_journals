    ...
    <div className="pt-28">
      ...
      <div class="max-w-4xl mx-auto my-16 px-4">
        ...
        <ul class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* <!-- Highlight 5 --> */}
          <li class="flex items-start gap-4 p-4 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 group md:col-span-2 md:justify-self-center md:max-w-md w-full">
